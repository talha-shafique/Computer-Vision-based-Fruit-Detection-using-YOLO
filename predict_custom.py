...
def predict_on_custom_images():
    ...
    custom_images_path = r'D:/Random Projects/Fruit Images for Object Detection/testing/'

    # Run inference on the custom images
    # The results will be saved in runs/detect/predict/ by default, with an incremented folder name
    results = model.predict(
        source=custom_images_path,
